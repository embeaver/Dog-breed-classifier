...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print('{:25}: {:3d}'.format('Number of Not Dog Images', results_stats_dic['n_notdogs_img']))
    ...
    # classified as dogs or visa versa
    if (print_incorrect_dogs and ( (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'])
        ...
        # Pet image label is Not-a-Dog - Classfied as a-dog
        for key in results_dic:
            if (results_dic[key][3] == '1' and (results_dic[key][4] == '0') ):
                print('pet label IS a dog: ,', results_dic[key][3], 
                      'and pet image label is NOT a dog:', results_dic[key][4])
            elif (results_dic[key][3] == '0' and (results_dic[key][4] == '1') ):
                print('pet label is NOT a dog: ,', results_dic[key][3], 
                      'and pet image label IS a dog:', results_dic[key][4])
