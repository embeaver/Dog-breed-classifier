...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        # if results dic index 2 matches '1', add 1 to n_match
        # Labels Match Exactly
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1
            
            # if results dic index 2 matches '1' AND results dic index 3 matches '1', add 1 to n_correct_breed
    ...
    # number of not-a-dog images using images and dog image counts
